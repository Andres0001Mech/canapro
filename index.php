        ...
        <div class="swiper-wrapper text-center">
          <div class="swiper-slide" data-slide-bg="images/slider-1-slide-2-1770x742.jpg">
            <div class="swiper-slide-caption section-md">
              <div class="container">
                <h1 data-caption-animate="fadeInLeft" data-caption-delay="0">Asóciate a CANAPRO C.A.C.</h1>
                <p class="text-width-large" data-caption-animate="fadeInRight" data-caption-delay="100">Si eres servidor
                  público en carrera administrativa, docente nombrado o pensionado, y tienes hijos o nietos menores de
                  18 años,
                  ¡asóciate a nuestra cooperativa con 51 años de trayectoria!</p><a
          ...
          <div class="swiper-slide" data-slide-bg="images/slider-1-slide-4-1770x742.jpg">
            <div class="swiper-slide-caption section-md">
              <div class="container">
                ...
                <p class="text-width-large" data-caption-animate="fadeInRight" data-caption-delay="100">Abre tu CDAT,
          ...
          <div class="swiper-slide" data-slide-bg="images/slider-1-slide-6-1770x742.jpg">
            <div class="swiper-slide-caption section-md">
              <div class="container">
                ...
                <p class="text-width-large" data-caption-animate="fadeInRight" data-caption-delay="100">Ahorra a tu
          ...
          <div class="col-lg-6 text-center wow fadeInUp" data-wow-delay=".1s">
            <div class="owl-carousel owl-style-1" data-items="2" data-stage-padding="0" data-loop="true" data-margin="0"
              data-mouse-drag="true" data-autoplay="true"><a class="box-device" href="#"><img
                  src="images/index-4-313x580.png" alt="" width="313" height="580" /></a><a class="box-device"
          ...
          <div class="footer-minimal-bottom-panel text-sm-left">
            <div class="row row-10 align-items-md-center">
              ...
              <div class="col-sm-6 col-md-4 order-sm-first">
                <!-- Rights-->
                <p class="rights"><span>&copy;&nbsp;</span><span class="copyright-year"></span> <span>Copyright © CANAPRO C.A.C. 2025</span>
                </p>
              </div>
              <div class="col-sm-6 col-md-4 text-md-right"><span> Todos los Derechos Reservados. Tunja, Boyacá, Colombia, Carrera 10 No. 22-97 PBX (8) 7439842 – Línea Gratuita 01 8000 941213, Email info@canaprooc.com.co</span>
...
<a href="https://wa.me/+573233199343?text=¡Hola Canapro c.a.c.!%20Quiero%20más%20información de:" 
