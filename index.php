...
<head>
  <title>Canapro c.a.c.</title>
  <meta name="format-detection" content="telephone=no">
  <meta name="viewport"
    content="width=device-width, height=device-height, initial-scale=1.0, maximum-scale=1.0, user-scalable=0">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <meta charset="utf-8">
  <link rel="icon" href="images/ico_cana-bg-preview.png" type="image/x-icon">
  <!-- Stylesheets-->
...
<body>
  ...
  <div class="page">
    <div id="home">
      <!-- Top Banner-->
      <!-- Top Banner--><a class="section section-banner text-center d-none d-xl-block" href="#"
        ...
        <div class="banner">
          Casa nacional del profesor <strong>CANAPRO C.A.C.</strong>Cooperativa de ahorro y crédito
          <button class="shop-btn">Consultar estado de cuenta!</button>
        </div>
      ...
      <style>
        ...
        .page-header {
          ...
          position: relative;
          z-index: 1000;
          /* asegura que quede sobre el contenido */
        }

        /* Si quieres un efecto más marcado */
        .page-header:hover {
              ...
              <div class="rd-navbar-main">
                ...
                <div class="rd-navbar-panel">
                  ...
                  <div class="rd-navbar-brand"><a class="brand" href="index.html"><img
                        src="images/canapro-cac-grande-h.png" alt="" width="223" height="40" /></a></div>
                </div>
                  ...
                  <div class="rd-navbar-nav-wrap">
                    ...
                    <div class="rd-navbar-share fl-bigmug-line-share27" data-rd-navbar-toggle=".rd-navbar-share-list">
                      <ul class="list-inline rd-navbar-share-list">
                        <li class="rd-navbar-share-list-item"><a class="icon fa fa-facebook" href="#" target="_blank"
                            rel="noopener noreferrer"></a></li>
                        <li class="rd-navbar-share-list-item">
                          <a href="https://x.com" target="_blank" rel="noopener noreferrer" class="icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                              viewBox="0 0 1200 1227">
                              <path
                                d="M714.163 519.284L1160.43 0H1051.3L667.137 442.509 392.765 0H0l468.062 729.049L0 1226.99h109.13l405.2-479.994 295.005 479.994h392.765L714.163 519.284zm-143.578 170.4l-46.978-74.822L148.905 79.076h169.797l301.163 479.994 46.978 74.822 404.187 645.104H901.233L570.585 689.684z" />
                            </svg>
                          </a>
                        </li>
                    ...
                    <ul class="rd-navbar-nav">
                      ...
                      <li class="rd-nav-item">
                        <a class="rd-nav-link" href="#services">Canapro</a>
                        <ul class="submenu">
                          <li><a href="">Régimen Tributario Especial</a></li>
                          <hr>
                          <li><a href="#opcion2">Balance Social</a></li>
                          <hr>
                          <li><a href="#opcion3">Directivos</a></li>
                          <hr>
                          <li><a href="#opcion3">Organigrama</a></li>
                          <hr>
                          <li><a href="#opcion3">Horizonte Institucional</a></li>
                          <hr>
                          <li><a href="#opcion3">Reseña Historica</a></li>
                          <hr>
                          <li><a href="#opcion3">Políticas</a></li>
                        </ul>
                      </li>
                      <li class="rd-nav-item"><a class="rd-nav-link" href="#">Asociados</a>
                        <ul class="submenu">
                          <li><a href="#opcion1">ESTADO DE CUENTA</a></li>
                          <hr>
                          ...
                          <hr>
                          <li><a href="#opcion3">APP MÓVIL</a></li>
                          <hr>
                          <li><a href="#opcion3">GUIA ESTADO DE CUENTA, WEB Y CURSOS VIRTUALES</a></li>
                      ...
                      <li class="rd-nav-item"><a class="rd-nav-link" href="#team">Servicios</a>
                        <ul class="submenu">
                          <li><a href="#opcion1">AHORRO</a></li>
                          <hr>
                          <li><a href="#opcion1">CRÉDITO</a></li>
                          <hr>
                          <li><a href="#opcion1">SOCIALES</a></li>
                          <hr>
                          <li><a href="#opcion1">CONVENIOS</a></li>
                        </ul>

                      </li>
                      <li class="rd-nav-item"><a class="rd-nav-link" href="#news">C vacacional</a></li>

                      <li class="rd-nav-item"><a class="rd-nav-link" href="#contacts">Contáctanos</a>
                        <ul class="submenu">
                          <li><a href="#opcion1">SEDES</a></li>
                          <hr>
                          <li><a href="#opcion1">CHAT CANALES VIRTUALES</a></li>
                          <hr>
                          <li><a href="#opcion1">PETICIONES, QUEJAS,<br> RECLAMOS Y FELICITACIONES</a></li>

                        </ul>


                      </li>
                      <li class="rd-nav-item"><a class="rd-nav-link" href="#contacts">Novedades</a></li>
                    </ul>
                  </div>
                </div>
              </div>
      ...
      <section class="section swiper-container swiper-slider swiper-slider-classic" data-loop="true"
        ...
        <div class="swiper-wrapper text-center">
          <div class="swiper-slide" data-slide-bg="images/flayer_azul1.png">
            <div class="swiper-slide-caption section-md">
              <div class="container">
                <h1 data-caption-animate="fadeInLeft" style="color:white;" data-caption-delay="0">ASÓCIATE A CANAPRO
                  C.A.C.</h1>
                <p style="color: white; font-size: 28px; line-height: 1.1; font-weight: 500; text-shadow: 1px 1px 4px rgba(0,0,0,0.4);"
                  class="text-width-large" data-caption-animate="fadeInRight" data-caption-delay="100">
                  Si eres <strong>servidor público en carrera administrativa</strong>,
                  <strong>docente nombrado</strong> o <strong>pensionado</strong>,
                  y tienes <strong>hijos o nietos menores de 18 años</strong>,<br>
                  <span style="font-size: 32px; line-height: 1; font-weight: 700; color: #ffd700;">
                    ¡Asóciate a nuestra cooperativa con 51 años de trayectoria!
                  </span><br>
                  <a class="button button-primary button-ujarak" href="#modalCta" data-toggle="modal"
                    data-caption-animate="fadeInUp" data-caption-delay="200">Más información</a>
                </p>

              </div>
            </div>
          </div>
          <div class="swiper-slide" data-slide-bg="images/flayer_naranja.png">
            <div class="swiper-slide-caption section-md">
              <div class="container">
                <h1 data-caption-animate="fadeInLeft" data-caption-delay="0">CRECE CON NOSOTROS</h1>
                <p style="font-size: 28px; line-height: 1.2;" class="text-width-large"
                  data-caption-animate="fadeInRight" data-caption-delay="100">Abre tu CDAT,
                  multiplica tus ahorros y aprovecha las mejores tasas, con la seguridad y rentabilidad que solo
                  nosotros ofrecemos.
                  El moneto de ahorrar y ganar es AHORA.
                </p><a class="button button-primary button-ujarak" href="#modalCta" data-toggle="modal"
                  data-caption-animate="fadeInUp" data-caption-delay="200">Más información</a>
              </div>
            </div>
          </div>
          <div class="swiper-slide" data-slide-bg="images/flayer_verde.png">
            <div class="swiper-slide-caption section-md">
              <div class="container">
                <h1 data-caption-animate="fadeInLeft" data-caption-delay="0">AHORRA HOY, ASEGURA TU MAÑANA</h1>
                <p style="font-size: 28px; line-height: 1.2;" class="text-width-large"
                  data-caption-animate="fadeInRight" data-caption-delay="100">Ahorra a tu
                  ritmo, elige plazos a tu medida y disfruta de total seguridad con las tasas
                  más rentables del mercado. Haz que tu dinero trabaje para ti.
                </p><a class="button button-primary button-ujarak" href="#modalCta" data-toggle="modal"
                  data-caption-animate="fadeInUp" data-caption-delay="200">Contacto</a>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="section section-sm section-first bg-default text-center" id="services">
      <div class="container">
        <div class="row row-30 justify-content-center">
          <div class="col-md-7 col-lg-5 col-xl-6 text-lg-left wow fadeInUp"><img width="415px" height="592"
              src="images/2148336933.png" alt="" width="415" height="592" />
          </div>
            ...
            <div class="row row-30">
              <div class="col-sm-6 wow fadeInRight">
                <article class="box-icon-modern box-icon-modern-custom">
                  <div>
                    <h3 class="box-icon-modern-big-title">Trámites rápidos</h3>
                    <div class="box-icon-modern-decor"></div><a class="button button-primary" href="#">Ver
                      servicios</a>
                  </div>
                </article>
              </div>
              <div class="col-sm-6 wow fadeInRight" data-wow-delay=".1s">
                <article class="box-icon-modern box-icon-modern-2">
                  ...
                  <h5 class="box-icon-modern-title"><a href="#">Experiencia en <br>nuestros servicios</a></h5>
                  <div class="box-icon-modern-decor"></div>
                  <p class="box-icon-modern-text">Experiencia en todos nuestros servicios y con la más alta calidad.
                  </p>
                </article>
              </div>
              <div class="col-sm-6 wow fadeInRight" data-wow-delay=".2s">
                <article class="box-icon-modern box-icon-modern-2">
                  ...
                  <h5 class="box-icon-modern-title"><a href="#">Gran grupo de <br>profesionales</a></h5>
                  <div class="box-icon-modern-decor"></div>
                  <p class="box-icon-modern-text">Contamos con un excelente grupo de trabajo especializado para
              ...
              <div class="col-sm-6 wow fadeInRight" data-wow-delay=".3s">
                <article class="box-icon-modern box-icon-modern-2">
                  ...
                  <h5 class="box-icon-modern-title"><a href="#">Buscamos tu <br>crecimiento</a></h5>
                  <div class="box-icon-modern-decor"></div>
                  <p class="box-icon-modern-text">En CANAPRO C.A.C. nuestro compromiso son nuestros asociados.</p>
                </article>
              </div>
            </div>
          </div>
    ...
    <!-- Cta-->
    <section class="section section-fluid bg-gradient">
      <div class="parallax-content section-xl context-dark">
        <div class="container">
          <div class="row row-30 justify-content-end text-right">
            <div class="col-sm-7">
              <h3 style="font-size: 60px;" class="wow fadeInLeft">Consulta rápida de estado de cuenta!</h3>
              <p style="font-size: 20px;">Accede de forma fácil y segura a la información de tu cuenta en cualquier
                momento.</p>
              <div class="group-sm group-middle group justify-content-end">
                <a class="button button-primary button-ujarak" href="#modalCta" data-toggle="modal">
                  Acceder a mi estado de cuenta
                </a>
                <a class="button button-white-outline button-ujarak" href="#">
                  Manual de ingreso
                </a>
              </div>
            </div>
    ...
    <section class="section section-sm section-fluid bg-default text-center" id="projects">
      <div class="container-fluid">
        <h2 class="wow fadeInLeft">CENTRO VACACIONAL CHIMINIGAGUA I.A.C.</h2>
        <p class="quote-jean wow fadeInRight" data-wow-delay=".1s">Ven con tu familia y vive una experiencia inolvidable
          en Moniquirá, Boyacá. Disfruta de un clima agradable y revitalizante, sumérgete en nuestras refrescantes
          piscinas y aprovecha la mejor infraestructura diseñada para tu comodidad y diversión.</p>
        <div class="isotope-filters isotope-filters-horizontal">
          ...
          <ul class="isotope-filters-list" id="isotope-3">
            ...
            <li><a href="#" data-isotope-filter="Type 1" data-isotope-group="gallery">Café Bar</a></li>
            <li><a href="#" data-isotope-filter="Type 2" data-isotope-group="gallery">Salón de Juegos</a></li>
            <li><a href="#" data-isotope-filter="Type 3" data-isotope-group="gallery">Piscina</a></li>
            <li><a href="#" data-isotope-filter="Type 4" data-isotope-group="gallery">Bolos</a></li>
          </ul>
        </div>
      ...
      <div class="container">
        <div class="row row-30 row-xl-24 justify-content-center align-items-center align-items-lg-start text-left">
          <div class="col-md-6 col-lg-5 col-xl-4 text-center"><a class="text-img" href="#">
              <div id="particles-js"></div><span class="counter">51</span>
            </a></div>
          <div class="col-sm-8 col-md-6 col-lg-5 col-xl-4">
            <div class="text-width-extra-small offset-top-lg-24 wow fadeInUp">
              ...
              <p class="text-gray-500">En CANAPRO C.A.C. celebramos 51 años caminando contigo, construyendo sueños,
                cuidando tu bienestar y creciendo juntos como una gran familia cooperativa.</p>
              <a class="button button-secondary button-pipaluk" href="#">Más información</a>
            </div>
          </div>
        ...
        <div class="row row-sm row-30 justify-content-center">
          <div class="col-md-6 col-lg-5 col-xl-3 wow fadeInRight">
            ...
            <article class="team-classic team-classic-lg"><a class="team-classic-figure" href="#"><img
                  src="images/ahorro2.png" alt="" width="420" height="424" /></a>
              <div class="team-classic-caption">
                <h4 class="team-classic-name"><a href="#">Ahorro</a></h4>
                <p class="team-classic-status">Servicio de Ahorro</p>
              </div>
            </article>
          </div>
          <div class="col-md-6 col-lg-5 col-xl-3 wow fadeInRight" data-wow-delay=".1s">
            <!-- Team Classic-->
            <article class="team-classic team-classic-lg"><a class="team-classic-figure" href="#"><img
                  src="images/credito.png" alt="" width="420" height="424" /></a>
              <div class="team-classic-caption">
                <h4 class="team-classic-name"><a href="#">Crédito</a></h4>
                <p class="team-classic-status">Servicio Crédito</p>
              </div>
            </article>
          </div>
          <div class="col-md-6 col-lg-5 col-xl-3 wow fadeInRight" data-wow-delay=".2s">
            <!-- Team Classic-->
            <article class="team-classic team-classic-lg"><a class="team-classic-figure" href="#"><img
                  src="images/social.png" alt="" width="420" height="424" /></a>
              <div class="team-classic-caption">
                <h4 class="team-classic-name"><a href="#">Sociales</a></h4>
                <p class="team-classic-status">Servicio Social</p>
              </div>
            </article>
          </div>
          <div class="col-md-6 col-lg-5 col-xl-3 wow fadeInRight" data-wow-delay=".3s">
            <!-- Team Classic-->
            <article class="team-classic team-classic-lg"><a class="team-classic-figure" href="#"><img
                  src="images/convenios.png" alt="" width="420" height="424" /></a>
              <div class="team-classic-caption">
                <h4 class="team-classic-name"><a href="#">Convenios</a></h4>
                <p class="team-classic-status">Servicio Convenios</p>
              </div>
            </article>
          </div>
        </div>
        ...
        <div class="row row-50 align-items-center justify-content-center justify-content-xl-between">
            ...
            <div class="tabs-custom tabs-horizontal tabs-line tabs-line-big text-center text-md-left" id="tabs-6">
              ...
              <ul class="nav nav-tabs">
                <li class="nav-item" role="presentation"><a class="nav-link nav-link-big active" href="#tabs-6-1"
                    data-toggle="tab">01</a></li>
                <li class="nav-item" role="presentation"><a class="nav-link nav-link-big" href="#tabs-6-2"
                    data-toggle="tab">02</a></li>
                <li class="nav-item" role="presentation"><a class="nav-link nav-link-big" href="#tabs-6-3"
                    data-toggle="tab">03</a></li>
                <li class="nav-item" role="presentation"><a class="nav-link nav-link-big" href="#tabs-6-4"
                    data-toggle="tab">04</a></li>
              </ul>
              <!-- Tab panes-->
              <div class="tab-content">
                <div class="tab-pane fade show active" id="tabs-6-1">
                  <h5 class="font-weight-normal">PODRÁN SER ASOCIADOS DE CANAPRO C.A.C.</h5>
                  <p>Ser mayor de 18 años y no estar afectado de inhabilidad civil o estatutaria y los hijos y nietos
                    menores de edad, con una autorización de su tutor.</p>
                  <div class="group-sm group-middle">
                    <a class="button button-secondary button-pipaluk" href="#modalCta" data-toggle="modal">Contactar
                      ahora</a><a class="button button-default-outline button-wapasha" href="#">Formulario</a>
                  </div>
                </div>
                <div class="tab-pane fade" id="tabs-6-2">
                  <h5 class="font-weight-normal">TIPO DE PERSONAS</h5>
                  <p>
                    > Las personas naturales que estén nombradas en propiedad o en periodo de prueba en entidades
                    educativas y los pensionados. <br>

                    > Las personas jurídicas que agrupen docentes y/o administrativos de la educación en el ámbito
                    territorial de la cooperativa. <br>

                    > Los servidores públicos vinculados en propiedad en carrera administrativa.
                ...
                <div class="tab-pane fade" id="tabs-6-3">
                  <h5 class="font-weight-normal">FAMILIARES</h5>
                  <p>

                    > Los hijos y nietos menores de edad, con autorización del asociado.
                  </p>
                  <div class="group-sm group-middle">
                    <a class="button button-secondary button-pipaluk" href="#modalCta" data-toggle="modal">Contactar
                      ahora</a><a class="button button-default-outline button-wapasha" href="#">Formulario</a>
                ...
                <div class="tab-pane fade" id="tabs-6-4">
                  <h5 class="font-weight-normal">REQUISITOS</h5>
                  <p>
                    > Copia del documento de identidad. <br>
                    > Dos últimos desprendibles de pago.<br>
                    > Diligenciar el formulario de admisión (deben estar diligenciados todos los campos del
                    formulario).<br>
                    > Firmar libranza de descuento.
                  </p>
                  <div class="group-sm group-middle">
                    <a class="button button-secondary button-pipaluk" href="#modalCta" data-toggle="modal">Contactar
                      ahora</a><a class="button button-default-outline button-wapasha" href="#">Formulario</a>
          ...
          <div class="col-lg-6 text-center wow fadeInUp" data-wow-delay=".1s">
            <div class="owl-carousel owl-style-1" data-items="2" data-stage-padding="0" data-loop="true" data-margin="0"
              data-mouse-drag="true" data-autoplay="true"><a class="box-device" href="#"><img
                  src="images/index-5-313x580.png" alt="" width="313" height="580" /></a><a class="box-device"
                href="#"><img src="images/index-5-313x580.png" alt="" width="313" height="580" /></a><a
                class="box-device" href="#"><img src="images/index-4-313x580.png" alt="" width="313"
                  height="580" /></a><a class="box-device" href="#"><img src="images/index-5-313x580.png" alt=""
                  width="313" height="580" /></a></div>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="section section-sm section-bottom-70 section-fluid bg-default">
      <div class="container-fluid">
        <h2>Testimonios de quienes confían en nosotros</h2>
        <div class="row row-50 row-sm">
          <div class="col-md-6 col-xl-4 wow fadeInRight">
            ...
            <article class="quote-modern quote-modern-custom">
              ...
              <div class="quote-modern-text">
                <p class="q">RatherApp offers a high caliber of resources skilled in Microsoft Azure .NET, mobile and
          ...
          <div class="col-md-6 col-xl-4 wow fadeInRight" data-wow-delay=".1s">
            ...
            <article class="quote-modern quote-modern-custom">
              ...
              <div class="quote-modern-text">
                <p class="q">RatherApp powered us with a competent team to develop products for banking services. The
          ...
          <div class="col-md-6 col-xl-4 wow fadeInRight" data-wow-delay=".2s">
            ...
            <article class="quote-modern quote-modern-custom">
              ...
              <div class="quote-modern-text">
                <p class="q">RatherApp is a highly skilled and uniquely capable firm with multitudes of talent on-board.
                  We have collaborated on a number of diverse projects that have been a great success.</p>
              </div>
            </article>
          </div>
        </div>
        ...
        <div class="row row-45">
          <div class="col-sm-6 col-lg-4 wow fadeInLeft">
            ...
            <article class="post post-modern"><a class="post-modern-figure" href="#"><img
                  src="images/imagen_afiliate.png" alt="" width="370" height="307" />
          ...
          <div class="col-sm-6 col-lg-4 wow fadeInLeft" data-wow-delay=".1s">
            <!-- Post Modern-->
            <article class="post post-modern"><a class="post-modern-figure" href="#"><img
                  src="images/actualizacion_datos_flayer.png" alt="" width="370" height="307" />
                <div class="post-modern-time">
          ...
          <div class="col-sm-6 col-lg-4 wow fadeInLeft" data-wow-delay=".2s">
            <!-- Post Modern-->
            <article class="post post-modern"><a class="post-modern-figure" href="#"><img src="images/flayer_cursos.png"
                  alt="" width="370" height="307" />
                <div class="post-modern-time">
                  Descubre Cursos
                </div>
              </a>
          ...
          <div class="col-sm-8 col-md-6 col-lg-4">
            <article class="box-contacts">
              <div class="box-contacts-body">
                ...
                <p class="box-contacts-link"><a href="tel:#">PBX (8) 7439842</a></p>
                <p class="box-contacts-link"><a href="tel:#">Línea Gratuita 01 8000 941213</a></p>
              </div>
            </article>
          </div>
          <div class="col-sm-8 col-md-6 col-lg-4">
            <article class="box-contacts">
              <div class="box-contacts-body">
                ...
                <div class="box-contacts-decor"></div>
                <p class="box-contacts-link"><a href="#">Tunja, Boyacá, Colombia, Carrera 10 No. 22-97</a></p>
              </div>
            </article>
          </div>
          <div class="col-sm-8 col-md-6 col-lg-4">
            <article class="box-contacts">
              <div class="box-contacts-body">
                ...
                <div class="box-contacts-decor"></div>
                <p class="box-contacts-link"><a href="mailto:#">info@canaprooc.com.co</a></p>
      ...
      <div class="container">
        <article class="title-classic">
          ...
          <div class="title-classic-text">
            <p>Estamos para ayudarte – Canapro C.A.C.</p>
          </div>
        </article>
          ...
          <div class="row row-14 gutters-14">
            ...
            <div class="col-md-4">
              <div class="form-wrap">
                ...
                <label class="form-label" for="contact-phone-2">Número Celular</label>
              </div>
            </div>
            <div class="col-12">
              <div class="form-wrap">
          ...
          <div class="footer-minimal-bottom-panel text-sm-left">
            <div class="row row-10 align-items-md-center">
              ...
              <div class="col-sm-6 col-md-4 order-sm-first">
                <!-- Rights-->
                <p class="rights"><span>&copy;&nbsp;</span><span class="copyright-year"></span> <span>Copyright ©
                    CANAPRO C.A.C. 2025</span>
                </p>
              </div>
              <div class="col-sm-6 col-md-4 text-md-right"><span> Todos los Derechos Reservados. Tunja, Boyacá,
                  Colombia, Carrera 10 No. 22-97 PBX (8) 7439842 – Línea Gratuita 01 8000 941213, Email
                  info@canaprooc.com.co</span>
                - <a href="#">Canapro c.a.c.</a></span>
              </div>
            </div>
          </div>
        </div>
  ...
  <a href="https://wa.me/+573233199343?text=¡Hola Canapro c.a.c.!%20Quiero%20más%20información de:" class="btn-whatsapp"
  ...
  <button class="chatbot-btn" onclick="toggleChat()">
    <img src="images/ico_cana-bg-preview.png" alt="Chatbot">
  </button>

  <!-- Contenedor del chatbot -->
  <div class="chatbot-card" id="chatbot">
    <div class="card-header">
      Asistente Virtual CANAPRO
      <img class="icono-chatbot" src="images/ico_cana-bg-preview.png" alt="Chatbot">

    </div>

    <div id="chatbox">
      <div class="msg-bot">¡Hola! 👋 ¿Cómo puedo ayudarte?</div>
      <div class="options-container">
        <button class="option-btn" data-value="Afiliación 📝" data-action="show_afiliaciones">Afiliación
          📝</button>
        <button class="option-btn" data-value="Ahorros 💰" data-action="show_ahorros">Ahorros 💰</button>
        <button class="option-btn" data-value="Créditos 💳" data-action="show_creditos">Créditos 💳</button>
        <button class="option-btn" data-value="Sedes 🏢" data-action="show_sedes">Sedes 🏢</button>
        <button class="option-btn" data-value="Otros Servicios ✨" data-action="show_servicios">Otros Servicios
          ✨</button>
      </div>
    </div>
  </div>

  <script src="js/chatbot_btn.js"></script>
